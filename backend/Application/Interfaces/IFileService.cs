...
public interface IFileService
{
    ...
    Task<ApiResponse<bool>> ShareFileAsync(Guid ownerId, Guid fileId, string targetEmailOrUsername);
    Task<PagedResponse<FileDto>> GetSharedWithMeFilesAsync(Guid userId, PagedRequest request);
    Task<ApiResponse<bool>> RemoveShareAsync(Guid ownerId, Guid fileId, Guid sharedWithUserId);
}
